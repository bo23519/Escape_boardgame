...
/**
 * This interface describes the behavior of the Escape game manager. Every
 * instance of an Escape game manager must implement this interface. The methods
 * described here are the only methods that a client can use when interacting
 * with the game.
 * 
 * MODIFIABLE: NO MOVEABLE: NO REQUIRED: YES
 * 
 * You may extend this interface for your internal use, but this is the public
 * interface that all clients will use.
 */
public interface EscapeGameManager<C extends Coordinate> {
	...
	/**
	 * Return the piece located at the specified coordinate. If executing this
	 * method in the game instance causes an exception, then this method returns
	 * null and sets the status message appropriately. The status message is not
	 * used in the initial release(s) of the game.
	 * 
