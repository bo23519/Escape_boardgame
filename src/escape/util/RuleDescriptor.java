...
/**
 * A JavaBean that represents an attribute for rule. This file is provided as an
 * example that can be used to initialize instances of a GameManager via the
 * EscapeBuilder. You do not have to use this, but are encouraged to do so.
 *
