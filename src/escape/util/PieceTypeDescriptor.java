...
/**
 * A JavaBean that represents a complete piece type description. This file is
 * provided as an example that can be used to initialize instances of a
 * GameManager via the EscapeBuilder. You do not have to use this, but are
 * encouraged to do so.
 *
...
public class PieceTypeDescriptor {
	...
	public PieceAttribute getAttribute(PieceAttributeID id) {
		Optional<PieceAttribute> attr = Arrays.stream(attributes).filter(a -> a.getId().equals(id)).findFirst();
	...
	public String toString() {
		return "PieceTypeInitializer [pieceName=" + pieceName + ", movementPattern=" + movementPattern + ", attributes="
