...
/**
 * An example of reading a game configuration file and storing the information
 * in this data object. Using this object, you can get the information needed to
 * create your game.
 * 
...
public class EscapeGameInitializer {
	...
	public String toString() {
		return "EscapeGameInitializer [xMax=" + xMax + ", yMax=" + yMax + ", coordinateType=" + coordinateType
				+ ", locationInitializers=" + Arrays.toString(locationInitializers) + ", types="
